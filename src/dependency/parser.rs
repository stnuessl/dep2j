...
mod tests {
    ...
    fn parse_targets_001() {
        ...
        unsafe {
            ...
            let end = begin.add(data.len());

            let ptr = parser.parse_targets(begin, end);
    ...
    fn parse_prerequisite_001() {
        ...
        unsafe {
            ...
            let (ptr, done) = parser.parse_prerequisite(0, begin, end);
    ...
    fn parse_prerequisites_001() {
        ...
        unsafe {
            ...
            let ptr = parser.parse_prerequisites(0, begin, end);
    ...
    fn parse_rule_001() {
        ...
        unsafe {
            ...
            let ptr = parser.parse_rule(begin, end);
